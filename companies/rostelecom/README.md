...
1. Заполните Excel: `data/excel/rostelecom_unified.xlsx`
...
```bash
# Полный прогон
python3 -m engine.orchestrator rostelecom --stress --rating

# Только модель
python3 -m engine.orchestrator rostelecom --no-preprocess
```
