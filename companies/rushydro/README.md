...
1. Заполните Excel: `data/excel/rushydro_unified.xlsx`
...
```bash
# Полный прогон
python3 -m engine.orchestrator rushydro --stress --rating

# Только модель
python3 -m engine.orchestrator rushydro --no-preprocess
```
