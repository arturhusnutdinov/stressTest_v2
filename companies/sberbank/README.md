...
1. Заполните Excel: `data/excel/sberbank_unified.xlsx`
...
```bash
# Полный прогон
python3 -m engine.orchestrator sberbank --stress --rating

# Только модель
python3 -m engine.orchestrator sberbank --no-preprocess
```
