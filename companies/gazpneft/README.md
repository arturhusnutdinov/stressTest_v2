...
1. Заполните Excel: `data/excel/gazpneft_unified.xlsx`
...
```bash
# Полный прогон
python3 -m engine.orchestrator gazpneft --stress --rating

# Только модель
python3 -m engine.orchestrator gazpneft --no-preprocess
```
