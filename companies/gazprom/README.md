...
1. Заполните Excel: `data/excel/gazprom_unified.xlsx`
...
```bash
# Полный прогон
python3 -m engine.orchestrator gazprom --stress --rating

# Только модель
python3 -m engine.orchestrator gazprom --no-preprocess
```
