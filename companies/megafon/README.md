...
1. Заполните Excel: `data/excel/megafon_unified.xlsx`
...
```bash
# Полный прогон
python3 -m engine.orchestrator megafon --stress --rating

# Только модель
python3 -m engine.orchestrator megafon --no-preprocess
```
